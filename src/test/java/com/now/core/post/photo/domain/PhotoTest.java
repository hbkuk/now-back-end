package com.now.core.post.photo.domain;
...
public class PhotoTest {
    ...
    class CanUpdate_of {
        ...
        void return_true_when_same_user() {
            ...
            Photo photo = PhotoFixture.createPhoto("tester1");

            // when, then
            assertThat(photo.canUpdate(member)).isTrue();
        }
        ...
        void throw_exception_when_not_same_user() {
            // given
            Member member = MemberFixture.createMember("tester1");
            Photo photo = PhotoFixture.createPhoto("tester2");
    ...
    class CanDelete_of {
        ...
        class SameUser {
            ...
            void return_true_when_nothing_comment() {
                ...
                // when, then
                assertThat(photo.canDelete(member, new ArrayList<Comment>())).isTrue();
            ...
            void return_true_when_same_comment_author() {
                ...
                // when, then
                assertThat(photo.canDelete(member, comments)).isTrue();
            }
            ...
            void throw_exception_when_not_same_comment_author() {
                ...
                assertThatExceptionOfType(CannotDeletePostException.class)
                        .isThrownBy(() -> {
                            photo.canDelete(member, comments);
                        })
        ...
        class NotSameUser {
            ...
            void throw_exception_when_nothing_comment() {
                ...
                assertThatExceptionOfType(CannotDeletePostException.class)
                        .isThrownBy(() -> {
                            photo.canDelete(member, new ArrayList<Comment>());
                        })
